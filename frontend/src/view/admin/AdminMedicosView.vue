  ...
  <div class="d-flex dashboard-wrapper">
    ...
    <main class="content flex-grow-1 p-4">
      <header class="d-flex justify-content-between align-items-center mb-4">
        ...
        <button class="btn btn-danger px-4 py-2 rounded-3 fw-bold d-flex align-items-center gap-2"
          @click="abrirModal()">
            ...
            <tr v-for="m in medicosFiltrados" :key="m.id">
              <td class="px-4 py-3">
                <div class="d-flex align-items-center gap-3">
                  <div
                    class="avatar-sm bg-red-soft text-danger fw-bold rounded-circle d-flex align-items-center justify-content-center">
                    {{ initials(m.nomeCompleto) }}</div>
              ...
              <td>
                <span v-for="esp in (m.especialidades_detalhes || [])" :key="esp.id"
                  class="badge bg-light text-muted border me-1 small">{{ esp.nome }}</span>
      ...
      <!-- Modal -->
      <div v-if="modalAberto" class="modal-overlay d-flex align-items-center justify-content-center"
        @click.self="fecharModal">
        <div class="modal-card p-4">
          <div class="d-flex justify-content-between align-items-center mb-4">
            <h5 class="fw-bold mb-0">{{ editando ? 'Editar Médico' : 'Novo Médico' }}</h5>
            <button class="btn btn-sm btn-outline-secondary rounded-circle" @click="fecharModal"><i
          ...
          <div class="row g-3">
            ...
            <div class="col-md-6">
              ...
              <input v-model="form.crm" class="form-control rounded-3" placeholder="CRM/SP 123456"
                :disabled="editando" />
            </div>
            <div class="col-md-6">
            ...
            <div class="col-12">
              ...
              <select v-model="form.especialidades_ids" class="form-select rounded-3" multiple style="height: 120px;">
